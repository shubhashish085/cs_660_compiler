...
public class ClassAndMemberFinder extends Visitor {
    ...
    public Object visitConstructorDecl(ConstructorDecl cd) {
		...
		// YOUR CODE HERE
		println(cd.line + ":\tInserting constructor '" + cd.getname() + "' with signature '"+ cd.paramSignature() + "' into method table for class '" +
				currentClass.name() + "'.");
		if(!cd.getname().equals(currentClass.getname())){
			Error.error("Constructor must be named the same as the class.");
		}
    ...
    public Object visitFieldDecl(FieldDecl fd) {
		...
		// YOUR CODE HERE
		println(fd.line + ":\tInserting field '" + fd.getname() + "' into field table of class '" +
				currentClass.name() + "'.");
	...
	println(md.line + ":\tInserting method '" + md.getname() + "' with signature '"+ md.paramSignature() + "' into method table for class '" +
				currentClass.name() + "'.");
	// YOUR CODE HERE
